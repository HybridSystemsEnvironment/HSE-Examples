...
public class Parameters {
	 ...
	 * is asynchronous)
	 */
	public State getSynchronizationAgent(State agent,
			Network<HybridSys<State>> network) {

		State syncAgent = agent;
		if (synchronous) {
	 ...
	 * @param synchronous
	 */
	public Parameters(Double controller_gain, Double minimum_comm, Double maximum_comm, boolean synchronous) {
