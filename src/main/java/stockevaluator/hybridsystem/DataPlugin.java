...
public class DataPlugin {
	 ...
	 */
	public static void createStockStates(Parameters parameters, State eval_state) {
		...
		for (String stockIndex : stockIndices) {
			if (stockIndex != null) // make sure index is non-null
			{
				try // attempt to create a stock state for the current index
				{
					...
					SubState newStock = new SubState(stockIndex);
	 ...
	 */
	public static SimpleRegression getStockLogHistory(ChartRange history_range, SubState state) {
	 ...
	 * @param history_ChartRange : ChartRange to load history data points
	 */
	public static SimpleRegression getStockHistory(ChartRange history_range, SubState state) {
	 ...
	 */
	public static Double getStockPrice(SubState state) {
	 ...
	 */
	public static List<Chart> getChartRequest(ChartRange history_range, SubState state) {
