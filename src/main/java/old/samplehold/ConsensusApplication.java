...
import old.bouncingball.BouncingBallState;
import old.consensus.ConsensusAgentState;
import old.consensus.ConsensusAgentSystem;
import old.consensus.ConsensusParameters;
...
public class ConsensusApplication {
	...
	public static Figure generateFullStateFigure(TrajectorySet solution) {
		...
		figure.addComponent(1, 0, generateFullStateFigurez(solution).getContentPanel());
