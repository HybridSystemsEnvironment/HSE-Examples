...
public class Parameters {
	 ...
	 *            constant
	 */
	public Parameters(double f, double R, double L, double Cap, double V, double e, double b) {
		this.f = f;
	 ...
	 */
	public static Parameters idealParameters(Double e) {
		Parameters idealParams = new Parameters(60.0, 1.0, 0.1, 6.66 * .00001, 220.0, e, 120.0);
		return idealParams;
	}
}
